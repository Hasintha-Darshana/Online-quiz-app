                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form class="w-3/4" method="POST" action="{{route('add-question')}}">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="answer1" id="answer1" class="text-input" required />
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="answer2" id="answer2" class="text-input" required />
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="answer3" id="answer3" class="text-input" required />
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="answer4" id="answer4" class="text-input" required />
